...
/// reasonable curve.
const MAX_SAMPLES_PER_MARK: usize = 4096;
...
const INITIAL_SUBS_PER_SPAN: usize = 8;
...
#[inline]
fn knot(j: usize, d: usize, n_ctrl: usize) -> f64 {
...
/// = P_{n−1}`.
#[inline]
fn find_span(t: f64, d: usize, n_ctrl: usize) -> usize {
    let domain_max = (n_ctrl - d) as f64;
    if t >= domain_max {
        return n_ctrl - 1;
    }
...
fn de_boor(ctrl: &[Point], degree: usize, t: f64) -> Point {
    let n = ctrl.len();
